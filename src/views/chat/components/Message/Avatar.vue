...
<template>
  <template v-if="image">
    <NAvatar v-if="isString(avatar) && avatar.length > 0" :src="avatar" :fallback-src="defaultAvatar" style="border-radius: 10px !important; overflow: hidden;" />
    <NAvatar v-else :src="defaultAvatar" style="border-radius: 10px !important; overflow: hidden;" />
  </template>
